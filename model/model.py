...
class CrossViTBlock(nn.Module):
    r""" Cross Vision Transformer Block.
...
class BasicLayer(nn.Module):
    """ A basic Cross Vision Transformer layer for one stage.
    ...
    def __init__(self, dim, input_resolution, depth, num_heads, window_size,
        ...
        self.blocks = nn.ModuleList([
            CrossViTBlock(dim=dim, input_resolution=input_resolution,
...
class UNetCrossViT(nn.Module):
    def __init__(self, opt):
        super(UNetCrossViT, self).__init__()
